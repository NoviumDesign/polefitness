...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
    ...
    if ( ! class_exists( 'WCFortnoxExtended' ) ) {
        ...
        class WC_Fortnox_Extended {
            ...
            private $advanced_accounting_key = 'woocommerce_fortnox_advanced_accounting_settings';
            ...
            public function __construct() {
                ...
                add_action( 'admin_init', array( &$this, 'register_woocommerce_advanced_accounting_settings' ));
            ...
            function register_woocommerce_fortnox_order_settings() {
                ...
                add_settings_field( 'woocommerce-fortnox-payment-options', 'Betalningsvillkor för order', array( &$this, 'field_option_text'), $this->order_settings_key, 'section_order', array ( 'tab_key' => $this->order_settings_key, 'key' => 'payment-options', 'desc' => 'Här anges Fortnox-koden för betalningsalternativ för ordern. Koder finns under INSTÄLLNINGAR->OFFERT/ORDER->BETALNINGSALTERNATIV i Fortnox.') );
                ...
                add_settings_field( 'woocommerce-fortnox-cost-center', 'Kostnadsställe', array( &$this, 'field_option_text'), $this->order_settings_key, 'section_order', array ( 'tab_key' => $this->order_settings_key, 'key' => 'cost-center', 'desc' => '') );
                add_settings_field( 'woocommerce-fortnox-freight-product-sku', 'Sätt frakt som produkt', array( &$this, 'field_option_text'), $this->order_settings_key, 'section_order', array ( 'tab_key' => $this->order_settings_key, 'key' => 'freight-product-sku', 'desc' => 'Om frakten skall skapas upp som en produktrad i ordern ange då dess artikelnummer här.') );
            }
